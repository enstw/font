...
- ASCII/拉丁字形（JetBrains Sans）：[Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0)
- Mono ASCII/拉丁字形（JetBrains Mono）：[SIL OFL 1.1](https://openfontlicense.org)
